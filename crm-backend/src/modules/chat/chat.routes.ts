...
router.post("/conversations/:id/tickets", authRequired, createTicketFromConversationHandler);

// get unreadConversation for assignee
router.get("/conversations/unread-count", authRequired, async (req: any, res) => {
  try {
...
router.get("/conversations/:conversationId/customer", authRequired, getConversationCustomerHandler);
