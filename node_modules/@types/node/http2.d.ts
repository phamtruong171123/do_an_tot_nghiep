...
declare module "http2" {
  ...
  export interface ServerHttp2Session<
    ...
    Http2Response extends typeof Http2ServerResponse<InstanceType<Http2Request>> =
   ...
   * @since v8.4.0
   */
  export class Http2ServerResponse<Request extends Http2ServerRequest = Http2ServerRequest>
