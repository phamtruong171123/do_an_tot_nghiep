...
if (canUseDOM) {
  ...
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$330 && (!document.documentMode || 9 < document.documentMode);
}
...
var reportGlobalError =
  ...
  supportsUserTiming =
    "undefined" !== typeof console && "function" === typeof console.timeStamp && !0,
...
function logComponentErrored(fiber, startTime, endTime) {
  supportsUserTiming &&
    ...
    null !== fiber &&
      console.timeStamp(fiber, startTime, endTime, "Components \u269b", void 0, "error"));
}
function logComponentEffect(fiber, startTime, endTime, selfTime, errors) {
  null !== errors
    ? supportsUserTiming &&
      ...
      null !== selfTime &&
        console.timeStamp(selfTime, startTime, endTime, "Components \u269b", void 0, "error"))
    : ((fiber = getComponentNameFromFiber(fiber)),
      null !== fiber &&
        supportsUserTiming &&
        console.timeStamp(
...
function logErroredRenderPhase(startTime, endTime) {
  !supportsUserTiming ||
    endTime <= startTime ||
    console.timeStamp("Errored", startTime, endTime, currentTrack, "Scheduler \u269b", "error");
}
...
function startUpdateTimerByLane(lane) {
  if (0 !== (lane & 127)) {
    ...
    if (lane !== transitionEventRepeatTime || newEventType$30 !== transitionEventType)
      transitionEventRepeatTime = -1.1;
...
function startHostActionTimer() {
  if (0 > blockingUpdateTime) {
    ...
    newEventTime !== blockingEventRepeatTime || newEventType !== blockingEventType
      ? (blockingEventRepeatTime = -1.1)
      : null !== newEventType && (blockingUpdateType = 1);
    blockingEventTime = newEventTime;
    blockingEventType = newEventType;
  }
  if (0 > transitionUpdateTime && ((transitionUpdateTime = now()), 0 > transitionStartTime)) {
      ...
      if (
        ...
        if (0 === revertLane)
          (null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane && (didReadFromEntangledAsyncAction$69 = !0));
        else if ((renderLanes & revertLane) === revertLane) {
          update = update.next;
          revertLane === currentEntangledLane && (didReadFromEntangledAsyncAction$69 = !0);
          continue;
        } else
          ((updateLane = {
            lane: 0,
...
function subscribeToStore(fiber, inst, subscribe) {
  return subscribe(function () {
    checkIfSnapshotChanged(inst) && (startUpdateTimerByLane(2), forceStoreRerender(fiber));
  });
}
...
function handleActionReturnValue(actionQueue, node, returnValue) {
  null !== returnValue && "object" === typeof returnValue && "function" === typeof returnValue.then
    ? returnValue.then(
        function (nextState) {
...
function updateEffectImpl(fiberFlags, hookFlags, create, deps) {
  ...
  null !== currentHook && null !== deps && areHookInputsEqual(deps, currentHook.memoizedState.deps)
...
function dispatchSetState(fiber, queue, action) {
  var lane = requestUpdateLane();
  dispatchSetStateInternal(fiber, queue, action, lane) && startUpdateTimerByLane(lane);
}
  ...
  if (isRenderPhaseUpdate(fiber)) {
    ...
    ((throwIfDuringRender = enqueueConcurrentHookUpdate(fiber, queue, action, 2)),
      null !== throwIfDuringRender &&
        (startUpdateTimerByLane(2), scheduleUpdateOnFiber(throwIfDuringRender, fiber, 2)));
}
      ...
      ? ("function" === typeof unresolvedOldProps &&
        ...
        (contextType$jscomp$0 =
          ...
          ? (oldContext ||
            ...
            "function" === typeof context.getSnapshotBeforeUpdate && (workInProgress.flags |= 1024))
...
function attemptEarlyBailoutIfNoScheduledUpdate(current, workInProgress, renderLanes) {
  switch (workInProgress.tag) {
    ...
    case 22:
      return (
        (workInProgress.lanes = 0),
        updateOffscreenComponent(current, workInProgress, renderLanes, workInProgress.pendingProps)
      );
    case 24:
      pushProvider(workInProgress, CacheContext, current.memoizedState.cache);
  }
  ...
  switch (workInProgress.tag) {
    ...
    case 4:
      return (
        ...
        (props = workInProgress.pendingProps),
        null === current
          ? (workInProgress.child = reconcileChildFibers(workInProgress, null, props, renderLanes))
          : reconcileChildren(current, workInProgress, props, renderLanes),
        workInProgress.child
      );
    case 11:
            ...
            $$typeof.parent !== props
              ? (($$typeof = { parent: props, cache: props }),
                ...
                0 === workInProgress.lanes &&
                  (workInProgress.memoizedState = workInProgress.updateQueue.baseState = $$typeof),
                pushProvider(workInProgress, CacheContext, props))
              : ((props = prevState.cache),
                pushProvider(workInProgress, CacheContext, props),
                props !== $$typeof.cache &&
...
function bubbleProperties(completedWork) {
  ...
  if (didBailout)
    if (0 !== (completedWork.mode & 2)) {
      for (
        var treeBaseDuration$118 = completedWork.selfBaseDuration, child$119 = completedWork.child;
        null !== child$119;
      )
      ...
      for (treeBaseDuration$118 = completedWork.child; null !== treeBaseDuration$118; )
        ((newChildLanes |= treeBaseDuration$118.lanes | treeBaseDuration$118.childLanes),
  ...
  switch (workInProgress.tag) {
        ...
        if (null !== renderLanes) {
          if (null === current) {
            ...
            0 !== (workInProgress.mode & 2) &&
              null !== renderLanes &&
              ((current = workInProgress.child),
              null !== current && (workInProgress.treeBaseDuration -= current.treeBaseDuration));
          } else
            (resetHydrationState(),
              0 === (workInProgress.flags & 128) &&
    ...
    case 13:
        ...
        if (null !== type && null !== type.dehydrated) {
          if (null === current) {
            ...
            0 !== (workInProgress.mode & 2) &&
              ...
              null !== type && (workInProgress.treeBaseDuration -= type.treeBaseDuration));
          } else
            (resetHydrationState(),
              0 === (workInProgress.flags & 128) && (type = workInProgress.memoizedState = null),
              (workInProgress.flags |= 4),
              bubbleProperties(workInProgress),
              0 !== (workInProgress.mode & 2) &&
                null !== type &&
      ...
      if (0 !== (workInProgress.flags & 128))
        return (
          (workInProgress.lanes = renderLanes),
          0 !== (workInProgress.mode & 2) && transferActualDuration(workInProgress),
          workInProgress
        );
      ...
      if (null === nextResource)
        ...
        if (!type)
          if (((current = findFirstSuspended(nextResource)), null !== current)) {
            ...
            2 * now$1() - newProps.renderingStartTime > workInProgressRootRenderTargetTime &&
...
function commitProfilerUpdate(finishedWork, current, commitStartTime, effectDuration) {
  try {
    ...
    case 12:
      flags & 4
        ? ((flags = pushNestedEffectDurations()),
          ...
          commitProfilerUpdate(finishedWork, current, commitStartTime, finishedRoot.effectDuration))
        : recursivelyTraverseLayoutEffects(finishedRoot, finishedWork);
      break;
    case 31:
      recursivelyTraverseLayoutEffects(finishedRoot, finishedWork);
    ...
    case 13:
      ...
      flags & 64 &&
        ...
        null !== finishedRoot &&
          ...
          null !== finishedRoot &&
            ((current = retryDehydratedSuspenseBoundary.bind(null, finishedWork)),
...
function commitMutationEffectsOnFiber(finishedWork, root) {
  ...
  switch (finishedWork.tag) {
    ...
    case 1:
      ...
      commitReconciliationEffects(finishedWork);
      flags & 512 &&
        (offscreenSubtreeWasHidden || null === current || safelyDetachRef(current, current.return));
      if (
        flags & 64 &&
        ...
        flags.shared.hiddenCallbacks =
          null === existingHiddenCallbacks ? current : existingHiddenCallbacks.concat(current);
      }
      break;
    case 26:
        ...
        if (null === current)
          ...
          currentResource !== flags
            ? (null === currentResource
              ...
              null === flags
                ? mountHoistable(existingHiddenCallbacks, finishedWork.type, finishedWork.stateNode)
                : acquireResource(existingHiddenCallbacks, flags, finishedWork.memoizedProps))
            : null === flags &&
        ...
        a: for (
          ...
          if (5 === root.tag || 26 === root.tag) {
            if (null === current) {
              ...
              try {
                if (((currentResource = wasHidden.stateNode), existingHiddenCallbacks))
    ...
    try {
      ...
      switch (hostParentFiber.tag) {
        ...
        case 4:
          ...
          insertOrAppendPlacementNodeIntoContainer(finishedWork, before$164, parent$163);
          break;
        default:
...
function recursivelyTraversePassiveMountEffects(
  ...
  if (
    ...
    (0 !== parentFiber.actualDuration &&
      (null === parentFiber.alternate || parentFiber.alternate.child !== parentFiber.child))
  )
    for (parentFiber = parentFiber.child; null !== parentFiber; ) {
  ...
  switch (finishedWork.tag) {
    ...
    case 15:
      0 !== (finishedWork.mode & 2) &&
        ...
        logComponentRender(finishedWork, finishedWork.actualStartTime, endTime, inHydratedSubtree);
    ...
    case 31:
      ...
      prevProfilerEffectDuration =
        null !== finishedWork.alternate ? finishedWork.alternate.memoizedState : null;
    ...
    case 13:
      ...
      (null !== wasInHydratedSubtree && null !== wasInHydratedSubtree.dehydrated)
        ? (inHydratedSubtree = !1)
        : ((wasInHydratedSubtree = finishedWork.deletions),
          null !== wasInHydratedSubtree &&
          0 < wasInHydratedSubtree.length &&
...
function recursivelyTraverseReconnectPassiveEffects(
  ...
  for (var child = parentFiber.child; null !== child; ) {
    ...
    includeWorkInProgressEffects &&
      ...
      0 !== (child.flags & 1) &&
      logComponentRender(child, child.actualStartTime, endTime, inHydratedSubtree);
...
function commitPassiveUnmountOnFiber(finishedWork) {
  ...
  switch (finishedWork.tag) {
    ...
    case 12:
      ...
      recursivelyTraversePassiveUnmountEffects(finishedWork);
      finishedWork.stateNode.passiveEffectDuration += bubbleNestedEffectDurations(
        prevProfilerEffectDuration
      );
      break;
    case 22:
  ...
  for (parentFiber = parentFiber.child; null !== parentFiber; ) {
    ...
    switch (deletions.tag) {
      ...
      case 22:
        ...
        instance._visibility & 2 &&
          ((instance._visibility &= -3), recursivelyTraverseDisconnectPassiveEffects(deletions));
        break;
      default:
        recursivelyTraverseDisconnectPassiveEffects(deletions);
    }
    ...
    if (0 === exitStatus) {
      ...
      a: {
        ...
        switch (renderWasConcurrent) {
          ...
          case 6:
            ...
            0 !== (forceSync & 127)
              ...
              : 0 !== (forceSync & 4194048) && (transitionSuspendedTime = yieldDuration);
            markRootSuspended(
              yieldEndTime,
              lanes,
        ...
        if (
          ...
          ((exitStatus = globalMostRecentFallbackTime + 300 - now$1()), 10 < exitStatus)
        ) {
          markRootSuspended(
            yieldEndTime,
            lanes,
...
function prepareFreshStack(root, lanes) {
  supportsUserTiming &&
    ...
    console.timeStamp("Idle Track", 0.003, 0.003, "Idle", "Scheduler \u269b", "primary-light"));
  var previousRenderStartTime = renderStartTime;
  renderStartTime = now();
  if (0 !== workInProgressRootRenderLanes && 0 < previousRenderStartTime) {
    setCurrentTrackFromLanes(workInProgressRootRenderLanes);
    if (3 === workInProgressRootExitStatus || 4 === workInProgressRootExitStatus)
  ...
  if (0 !== (lanes & 127)) {
    ...
    0 <= blockingSuspendedTime &&
      ...
      logSuspendedWithDelayPhase(blockingSuspendedTime, clampedRenderStartTime$203, lanes));
    ...
    supportsUserTiming &&
      ...
      0 < previousRenderStartTime
        ...
        : (previousRenderStartTime = renderStartTime$jscomp$0),
      0 < endTime
        ? endTime > previousRenderStartTime && (endTime = previousRenderStartTime)
        : (endTime = previousRenderStartTime),
      null !== clampedRenderStartTime$203 &&
        previousRenderStartTime > endTime &&
        console.timeStamp(
          eventIsRepeat ? "Consecutive" : "Event: " + clampedRenderStartTime$203,
          endTime,
          previousRenderStartTime,
          currentTrack,
          "Scheduler \u269b",
  ...
  0 !== (lanes & 4194048) &&
    ...
    0 <= transitionSuspendedTime &&
      ...
      logSuspendedWithDelayPhase(transitionSuspendedTime, eventIsRepeat, lanes)),
    ...
    supportsUserTiming &&
      ...
      0 < endTime
        ? endTime > renderStartTime$jscomp$0 && (endTime = renderStartTime$jscomp$0)
        : (endTime = renderStartTime$jscomp$0),
      0 < previousRenderStartTime
        ? previousRenderStartTime > endTime && (previousRenderStartTime = endTime)
        : (previousRenderStartTime = endTime),
      0 < clampedRenderStartTime$203
  ...
  if (workInProgressRoot !== root || workInProgressRootRenderLanes !== lanes) {
    if (isDevToolsPresent) {
      ...
      0 < memoizedUpdaters.size &&
        (restorePendingUpdaters(root, workInProgressRootRenderLanes), memoizedUpdaters.clear());
  ...
  if (unitOfWork.flags & 32768) {
    if (isHydrating || 1 === suspendedReason) root = !0;
      ...
      ((suspendedReason = suspenseHandlerStackCursor.current),
        null !== suspendedReason && 13 === suspendedReason.tag && (suspendedReason.flags |= 16384));
    ...
    0 !== (abortedViewTransition & 261930) && 0 !== (remainingLanes & 42)
      ? ((nestedUpdateScheduled = !0),
        startViewTransitionStartTime === rootWithNestedUpdates
          ? nestedUpdateCount++
          : ((nestedUpdateCount = 0), (rootWithNestedUpdates = startViewTransitionStartTime)))
      : (nestedUpdateCount = 0);
    rootDidHavePassiveEffects || finalizeRender(abortedViewTransition, commitEndTime);
...
function pingSuspendedRoot(root, wakeable, pingedLanes) {
  ...
  0 !== (pingedLanes & 127)
    ? 0 > blockingUpdateTime &&
      ((blockingClampTime = blockingUpdateTime = now()), (blockingUpdateType = 2))
    : 0 !== (pingedLanes & 4194048) &&
      0 > transitionUpdateTime &&
      ((transitionClampTime = transitionUpdateTime = now()), (transitionUpdateType = 2));
  workInProgressRoot === root &&
          ...
          if (0 !== syncTransitionLanes) {
            ...
            ((JSCompiler_inline_result = workInProgressRootRenderLanes),
              (JSCompiler_inline_result = getNextLanes(
                ...
                null !== root$213.cancelPendingCommit || -1 !== root$213.timeoutHandle
              )),
...
for (
  ...
  var eventName$jscomp$inline_1876 = simpleEventPluginEvents[i$jscomp$inline_1875],
    domEventName$jscomp$inline_1877 = eventName$jscomp$inline_1876.toLowerCase(),
    capitalizedEvent$jscomp$inline_1878 =
      eventName$jscomp$inline_1876[0].toUpperCase() + eventName$jscomp$inline_1876.slice(1);
  registerSimpleEvent(domEventName$jscomp$inline_1877, "on" + capitalizedEvent$jscomp$inline_1878);
}
...
function setProp(domElement, tag, key, value, props, prevValue) {
  switch (key) {
    ...
    case "download":
      !0 === value
        ? domElement.setAttribute(key, "")
        : !1 !== value && null != value && "function" !== typeof value && "symbol" !== typeof value
          ? domElement.setAttribute(key, value)
          : domElement.removeAttribute(key);
      break;
    case "cols":
        ...
        if (props.hasOwnProperty(hasSrc)) {
          ...
          if (null != propValue$227)
            switch (hasSrc) {
              ...
              case "children":
              case "dangerouslySetInnerHTML":
                if (null != propValue$227) throw Error(formatProdErrorMessage(137, tag));
                break;
              default:
      ...
      if (isCustomElement(tag)) {
        for (propValue$227 in props)
          props.hasOwnProperty(propValue$227) &&
            ...
            void 0 !== hasSrc &&
              setPropOnCustomElement(domElement, tag, propValue$227, hasSrc, props, void 0));
        return;
      }
  }
  ...
  switch (tag) {
    ...
    case "input":
      ...
      for (var propKey$244 in nextProps) {
        ...
        if (nextProps.hasOwnProperty(propKey$244) && (null != propKey || null != lastProp))
          switch (propKey$244) {
            case "type":
              type = propKey;
              break;
            ...
            default:
              propKey !== lastProp &&
                setProp(domElement, tag, propKey$244, propKey, nextProps, lastProp);
          }
      }
      updateInput(
        domElement,
        ...
        if (
          ...
          switch (propKey$260) {
            case "selected":
              ...
              break;
            default:
              setProp(domElement, tag, propKey$260, null, nextProps, propKey$244);
          }
      for (lastDefaultValue in nextProps)
        if (
          ...
          switch (lastDefaultValue) {
            case "selected":
              domElement.selected =
                propKey$244 && "function" !== typeof propKey$244 && "symbol" !== typeof propKey$244;
              break;
            default:
              setProp(domElement, tag, lastDefaultValue, propKey$244, nextProps, propKey);
          }
      return;
    case "img":
    case "link":
      ...
      for (checked in nextProps)
        if (
          ...
          switch (checked) {
            case "children":
            case "dangerouslySetInnerHTML":
              if (null != propKey$244) throw Error(formatProdErrorMessage(137, tag));
              break;
            default:
              setProp(domElement, tag, checked, propKey$244, nextProps, propKey);
          }
      return;
    default:
      if (isCustomElement(tag)) {
        for (var propKey$270 in lastProps)
          ((propKey$244 = lastProps[propKey$270]),
            lastProps.hasOwnProperty(propKey$270) &&
              ...
              setPropOnCustomElement(domElement, tag, propKey$270, void 0, nextProps, propKey$244));
  ...
  if (ownerDocument && href) {
    ...
    if (!resource) {
      ...
      if ((resource = ownerDocument.querySelector(getStylesheetSelectorFromKey(key))))
        ...
        href = assign({ rel: "stylesheet", href: href, "data-precedence": precedence }, options);
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$286 = getResourcesFromRoot(JSCompiler_inline_result).hoistableStyles,
        ...
        resource$287 ||
          ...
          (styles$286 = JSCompiler_inline_result.querySelector(
            ...
            !styles$286._p &&
            ((resource$287.instance = styles$286), (resource$287.state.loading = 5)),
          preloadPropsMap.has(type) ||
            ...
            styles$286 ||
              preloadStylesheet(JSCompiler_inline_result, type, pendingProps, resource$287.state)));
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$292 = hoistableRoot.querySelector(getStylesheetSelectorFromKey(styleProps));
        if (instance$292)
          return (
      ...
      case "script":
        ...
        if ((styleProps = hoistableRoot.querySelector(getScriptSelectorFromKey(instance$292))))
    ...
    for (queuedTarget = 0; queuedTarget < i.length; queuedTarget += 3) {
      ...
      if ("function" === typeof submitterOrAction) formProps || scheduleReplayQueueIfNeeded(i);
        ...
        if (submitterOrAction && submitterOrAction.hasAttribute("formAction"))
          if (
            ((form = submitterOrAction), (formProps = submitterOrAction[internalPropsKey] || null))
          )
...
if ("19.2.0" !== isomorphicReactPackageVersion$jscomp$inline_2138)
  throw Error(
    formatProdErrorMessage(527, isomorphicReactPackageVersion$jscomp$inline_2138, "19.2.0")
  );
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (!hook$jscomp$inline_2659.isDisabled && hook$jscomp$inline_2659.supportsFiber)
    try {
      ((rendererID = hook$jscomp$inline_2659.inject(internals$jscomp$inline_2658)),
...
exports.flushSync = function (fn) {
  ...
  try {
    if (((ReactSharedInternals.T = null), (ReactDOMSharedInternals.p = 2), fn)) return fn();
  } finally {
