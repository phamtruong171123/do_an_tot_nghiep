  ...
  try {
    ...
    if ("function" === typeof result) {
      var continuationOptions = { signal: node._controller.signal },
        nextTask = runTask.bind(null, priorityLevel, postTaskPriority, node, result);
...
exports.unstable_scheduleCallback = function (priorityLevel, callback, options) {
  ...
  scheduler
    .postTask(runTask.bind(null, priorityLevel, postTaskPriority, controller, callback), options)
