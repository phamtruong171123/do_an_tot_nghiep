...
function handleTimeout(currentTime) {
  ...
  if (!isHostCallbackScheduled)
    if (null !== peek(taskQueue)) ((isHostCallbackScheduled = !0), (scheduledCallback = flushWork));
    else {
...
function flushWork(hasTimeRemaining, initialTime) {
  ...
  isHostTimeoutScheduled &&
    ((isHostTimeoutScheduled = !1), (scheduledTimeout = null), (timeoutTime = -1));
  isPerformingWork = !0;
  ...
  try {
    a: {
      ...
      for (
        ...
        null !== currentTask &&
        (!(currentTask.expirationTime > initialTime) || (hasTimeRemaining && !shouldYieldToHost()));
      ) {
        ...
        if ("function" === typeof callback) {
          ...
          } else (currentTask === peek(taskQueue) && pop(taskQueue), advanceTimers(initialTime));
        } else pop(taskQueue);
        currentTask = peek(taskQueue);
      }
...
exports.log = function (value) {
  "disabledLog" === console.log.name ||
    disableYieldValue ||
    (null === yieldedValues ? (yieldedValues = [value]) : yieldedValues.push(value));
};
...
exports.unstable_advanceTime = function (ms) {
  "disabledLog" === console.log.name ||
    ...
    null !== scheduledTimeout &&
      ...
      (scheduledTimeout(currentMockTime), (timeoutTime = -1), (scheduledTimeout = null)));
};
...
exports.unstable_scheduleCallback = function (priorityLevel, callback, options) {
  ...
  "object" === typeof options && null !== options
    ? ((options = options.delay),
      (options = "number" === typeof options && 0 < options ? currentTime + options : currentTime))
    : (options = currentTime);
  switch (priorityLevel) {
    case 1:
      var timeout = -1;
