...
function createResolverFunctions(kwargs) {
  ...
  const resolveModuleNames = (
    ...
    return moduleNames.map((moduleName, i) => {
      ...
      const mode = containingSourceFile
        ? (_b = (_a = ts).getModeForResolutionAtIndex) === null || _b === void 0
          ? void 0
          : _b.call(_a, containingSourceFile, i)
        : undefined;
      ...
      if (!resolvedModule && options.experimentalTsImportSpecifiers) {
        ...
        if (ext) {
          ...
          for (const replacementExt of replacements !== null &&
          replacements !== void 0
            ? replacements
            : []) {
  ...
  const resolveTypeReferenceDirectives = (
    ...
    redirectedReference,
    options,
    containingFileMode, // new impliedNodeFormat is accepted by compilerHost
  ) => {
    ...
    return typeDirectiveNames.map((typeDirectiveName) => {
      ...
      if (typeDirectiveName === 'node' && !resolvedTypeReferenceDirective) {
        ...
        if (typesNodePackageJsonPath) {
          const typeRoots = [
            (0, path_1.resolve)(typesNodePackageJsonPath, '../..'),
          ];
