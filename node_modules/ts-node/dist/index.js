...
exports.createEsmHooks =
  exports.createFromPreloadedConfig =
  exports.create =
  exports.register =
  exports.TSError =
  exports.DEFAULTS =
...
exports.DEFAULTS = {
  cwd:
    (_a = exports.env.TS_NODE_CWD) !== null && _a !== void 0
      ? _a
      : exports.env.TS_NODE_DIR,
  ...
  experimentalReplAwait:
    (_b = (0, util_1.yn)(exports.env.TS_NODE_EXPERIMENTAL_REPL_AWAIT)) !==
      null && _b !== void 0
      ? _b
      : undefined,
...
function register(serviceOrOpts) {
  ...
  if (
    !(serviceOrOpts === null || serviceOrOpts === void 0
      ? void 0
      : serviceOrOpts[TS_NODE_SERVICE_BRAND])
  ) {
    // Not a service; is options
    service = create(
      serviceOrOpts !== null && serviceOrOpts !== void 0 ? serviceOrOpts : {},
    );
  }
...
function createFromPreloadedConfig(foundConfigResult) {
  ...
  const projectLocalResolveHelper = (0, util_1.createProjectLocalResolveHelper)(
    projectLocalResolveDir,
  );
  ...
  const configFileDirname = configFilePath
    ? (0, path_1.dirname)(configFilePath)
    : null;
  const scopeDir =
    (_c =
      (_b =
        (_a = options.scopeDir) !== null && _a !== void 0
          ? _a
          : config.options.rootDir) !== null && _b !== void 0
        ? _b
        : configFileDirname) !== null && _c !== void 0
      ? _c
      : cwd;
  const ignoreBaseDir =
    configFileDirname !== null && configFileDirname !== void 0
      ? configFileDirname
      : cwd;
    ...
    if (transpiler) {
      ...
      const transpilerOptions =
        typeof transpiler === 'string'
          ? {}
          : (_a = transpiler[1]) !== null && _a !== void 0
            ? _a
            : {};
      ...
      function createTranspiler(compilerOptions, nodeModuleEmitKind) {
        return transpilerFactory === null || transpilerFactory === void 0
          ? void 0
          : transpilerFactory({
              service: {
                options,
  ...
  function installSourceMapSupport() {
    ...
    sourceMapSupport.install({
      ...
      retrieveFile(pathOrUrl) {
        ...
        return (
          ((_a = outputCache.get(path)) === null || _a === void 0
            ? void 0
            : _a.content) || ''
        );
      },
  ...
  const moduleTypeClassifier = (0,
  module_type_classifier_1.createModuleTypeClassifier)({
    basePath:
      (_d = options.optionBasePaths) === null || _d === void 0
        ? void 0
        : _d.moduleTypes,
    patterns: options.moduleTypes,
  });
  const extensions = (0, file_extensions_1.getExtensions)(
    config,
    options,
    ts.version,
  );
  ...
  if (!transpileOnly) {
    ...
    const cachedReadFile = (0, util_1.cachedLookup)(
      debugFn('readFile', readFile),
    );
    ...
    if (!options.compilerHost) {
      ...
      const sys = {
        ...
        resolvePath: (0, util_1.cachedLookup)(
      ...
      getOutput = (code, fileName) => {
        ...
        if (outText === '') {
          if (program.isSourceFileFromExternalLibrary(sourceFile)) {
            throw new TypeError(
              `Unable to compile file from external library: ${(0, path_1.relative)(cwd, fileName)}`,
            );
          }
          throw new TypeError(
            `Unable to require file: ${(0, path_1.relative)(cwd, fileName)}\n` +
  ...
  function createTranspileOnlyGetOutputFunction(
    ...
    let customTranspiler =
      createTranspiler === null || createTranspiler === void 0
        ? void 0
        : createTranspiler(compilerOptions, nodeModuleEmitKind);
  ...
  function compile(code, fileName, lineOffset = 0) {
    ...
    if (
      ...
      const classification = (0, node_module_type_classifier_1.classifyModule)(
        fileName,
        isNodeModuleType,
      );
      [value, sourceMap] =
  ...
  const getNodeEsmResolver = (0, util_1.once)(() =>
    require('../dist-raw/node-internal-modules-esm-resolve').createResolve({
      extensions,
  ...
  const getNodeEsmGetFormat = (0, util_1.once)(() =>
    require('../dist-raw/node-internal-modules-esm-get_format').createGetFormat(
      options.experimentalSpecifierResolution,
      getNodeEsmResolver(),
    ),
  );
  const getNodeCjsLoader = (0, util_1.once)(() =>
    require('../dist-raw/node-internal-modules-cjs-loader').createCjsLoader({
      extensions,
      preferTsExts: options.preferTsExts,
...
function registerExtensions(
  ...
  for (const cannotAdd of ['.mts', '.cts', '.mjs', '.cjs']) {
    if (
      exts.has(cannotAdd) &&
      !(0, util_1.hasOwnProperty)(require.extensions, cannotAdd)
    ) {
