...
exports.createEsmHooks =
  exports.registerAndCreateEsmHooks =
  exports.filterHooksByAPIVersion =
    void 0;
    ...
    async function entrypointFallback(cb) {
      try {
        ...
        try {
          ...
          const resolution = (0, url_1.pathToFileURL)(
            (0, module_1.createRequire)(process.cwd()).resolve(cjsSpecifier),
          ).toString();
  ...
  async function load(url, context, defaultLoad) {
    return addShortCircuitFlag(async () => {
      ...
      if (format !== 'builtin' && format !== 'commonjs') {
        ...
        const defaultTransformSource = async (
          source,
          _context,
  ...
  async function getFormat(url, context, defaultGetFormat) {
    ...
    if (nodeEquivalentExt && !tsNodeIgnored) {
      nodeSays = await entrypointFallback(() =>
        defer(
          (0, url_1.format)(
            (0, url_1.pathToFileURL)(nativePath + nodeEquivalentExt),
          ),
        ),
      );
    } else {
