...
var ServerStorage =
  globalVar.___reactRouterServerStorage___ ??
  (globalVar.___reactRouterServerStorage___ = new AsyncLocalStorage());
var redirect2 = (...args) => {
...
function prependBasenameToRedirectResponse(response, basename = "/") {
  ...
  response.headers.set("Location", prependBasename({ basename, pathname: redirect3 }));
  return response;
}
async function processServerAction(
  ...
  if (actionId) {
    ...
    let formData =
      maybeFormData && typeof maybeFormData === "object" && maybeFormData instanceof FormData
        ? maybeFormData
        : null;
    ...
    element = !isBelowErrorBoundary
      ? React2.createElement(
          ...
          isClientReference(Component)
            ? React2.createElement(WithComponentProps, {
            ...
            : React2.createElement(Component, {
                ...
                actionData,
                params,
                matches: staticContext.matches.map((match2) =>
                  convertRouteMatchToUiMatch(match2, staticContext.loaderData)
                ),
              })
        )
  ...
  const errorElement = ErrorBoundary
    ? React2.createElement(
        ...
        isClientReference(ErrorBoundary)
          ? React2.createElement(WithErrorBoundaryProps, {
  ...
  const hydrateFallbackElement = HydrateFallback
    ? React2.createElement(
        ...
        isClientReference(HydrateFallback)
          ? React2.createElement(WithHydrateFallbackProps, {
...
async function getManifestRoute(route) {
  ...
  const errorElement = route.ErrorBoundary
    ? React2.createElement(Layout, null, React2.createElement(route.ErrorBoundary))
    : void 0;
  return {
