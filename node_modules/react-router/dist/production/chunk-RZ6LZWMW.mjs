...
function createStaticHandler(routes, opts) {
  ...
  async function queryRoute(
    request,
    { routeId, requestContext, dataStrategy, generateMiddlewareResponse } = {}
  ) {
    let url = new URL(request.url);
    let method = request.method;
    let location = createLocation("", createPath(url), null, "default");
...
function isDataStrategyResult(result) {
  return (
    ...
    "type" in result &&
    "result" in result &&
    (result.type === "data" /* data */ || result.type === "error") /* error */
  );
}
...
function isRedirectResponse(result) {
  return (
    isResponse(result) && isRedirectStatusCode(result.status) && result.headers.has("Location")
  );
}
...
function useOutlet(context) {
  ...
  return React2.useMemo(
    () =>
      outlet &&
      /* @__PURE__ */ React2.createElement(OutletContext.Provider, { value: context }, outlet),
    [outlet, context]
  );
}
function useParams() {
...
function DefaultErrorComponent() {
  ...
  if (ENABLE_DEV_WARNINGS) {
    ...
    devInfo = /* @__PURE__ */ React2.createElement(
      React2.Fragment,
      null,
      /* @__PURE__ */ React2.createElement("p", null, "\u{1F4BF} Hey developer \u{1F44B}"),
      /* @__PURE__ */ React2.createElement(
        "p",
        null,
        "You can provide a way better UX than this when your app throws errors by providing your own ",
        /* @__PURE__ */ React2.createElement("code", { style: codeStyles }, "ErrorBoundary"),
        " or",
        " ",
        /* @__PURE__ */ React2.createElement("code", { style: codeStyles }, "errorElement"),
        " prop on your route."
      )
    );
  }
  return /* @__PURE__ */ React2.createElement(
    React2.Fragment,
    null,
    /* @__PURE__ */ React2.createElement("h2", null, "Unexpected Application Error!"),
    /* @__PURE__ */ React2.createElement("h3", { style: { fontStyle: "italic" } }, message),
    stack ? /* @__PURE__ */ React2.createElement("pre", { style: preStyles }, stack) : null,
    devInfo
  );
}
...
function _renderMatches(
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0)
      ? /* @__PURE__ */ React2.createElement(RenderErrorBoundary, {
...
function UNSTABLE_TransitionEnabledRouterProvider({
  ...
  router.__setPendingRerender = (promise) =>
    startRevalidation(
        ...
        while (Object.keys(encoder.deferred).length > 0) {
          for (const [deferredId, deferred] of Object.entries(encoder.deferred)) {
            ...
            seenPromises.add(
              ...
              (encoder.deferred[Number(deferredId)] = Promise.race([racePromise, deferred])
                .then(
                  (resolved) => {
  ...
  if (done) {
    ...
    return /* @__PURE__ */ React4.createElement(
      ...
      /* @__PURE__ */ React4.createElement(
        React4.Suspense,
        null,
        /* @__PURE__ */ React4.createElement(StreamTransfer, {
          context,
      ...
      ...(Component4
        ? {
            element: /* @__PURE__ */ React6.createElement(
              routeModule.Layout,
              null,
              /* @__PURE__ */ React6.createElement(Component4, null)
            ),
          }
  ...
  return /* @__PURE__ */ React8.createElement(
    ...
    keyedLinks.map(({ key, link }) =>
      isPageLinkDescriptor(link)
        ? /* @__PURE__ */ React8.createElement(PrefetchPageLinks, { key, nonce, ...link })
        : /* @__PURE__ */ React8.createElement("link", { key, nonce, ...link })
    )
  );
}
function PrefetchPageLinks({ page, ...linkProps }) {
  ...
  return /* @__PURE__ */ React8.createElement(PrefetchPageLinksImpl, {
    page,
    matches,
    ...linkProps,
  });
...
function Meta() {
  ...
  return /* @__PURE__ */ React8.createElement(
    ...
    meta.flat().map((metaProps) => {
      ...
      return /* @__PURE__ */ React8.createElement("meta", {
...
function Scripts(scriptProps) {
  let { manifest, serverHandoffString, isSpaMode, renderMeta, routeDiscovery, ssr } =
    useFrameworkContext();
...
import(${JSON.stringify(manifest.entry.module)});`;
    return /* @__PURE__ */ React8.createElement(
      React8.Fragment,
      null,
      /* @__PURE__ */ React8.createElement("script", {
        ...scriptProps,
...
var RemixErrorBoundary = class extends React9.Component {
  ...
  render() {
    if (this.state.error) {
      return /* @__PURE__ */ React9.createElement(RemixRootDefaultErrorBoundary, {
...
function RemixRootDefaultErrorBoundary({ error, isOutsideRemixApp }) {
  console.error(error);
  let heyDeveloper = /* @__PURE__ */ React9.createElement("script", {
    dangerouslySetInnerHTML: {
      __html: `
        console.log(
...
function BoundaryShell({ title, renderScripts, isOutsideRemixApp, children }) {
  ...
  return /* @__PURE__ */ React9.createElement(
    ...
    /* @__PURE__ */ React9.createElement(
      "head",
      null,
      /* @__PURE__ */ React9.createElement("meta", { charSet: "utf-8" }),
      /* @__PURE__ */ React9.createElement("meta", {
        name: "viewport",
        content: "width=device-width,initial-scale=1,viewport-fit=cover",
      }),
      /* @__PURE__ */ React9.createElement("title", null, title)
    ),
    /* @__PURE__ */ React9.createElement(
      "body",
      null,
      /* @__PURE__ */ React9.createElement(
        ...
        children,
        renderScripts ? /* @__PURE__ */ React9.createElement(Scripts, null) : null
      )
    )
  );
}
...
var Link = React10.forwardRef(function LinkWithRef(
  ...
  return shouldPrefetch && !isAbsolute
    ? /* @__PURE__ */ React10.createElement(
        ...
        null,
        link,
        /* @__PURE__ */ React10.createElement(PrefetchPageLinks, { page: href })
      )
    : link;
});
...
function useFetcher({ key } = {}) {
  ...
  let unstable_reset = React10.useCallback(
...
function StaticRouterProvider({ context, router, hydrate: hydrate2 = true, nonce }) {
  ...
  return /* @__PURE__ */ React11.createElement(
    ...
    hydrateScript
      ? /* @__PURE__ */ React11.createElement("script", {
          suppressHydrationWarning: true,
          nonce,
