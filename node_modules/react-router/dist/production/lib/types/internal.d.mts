import {
  ...
  j as MetaDescriptor,
  G as GetLoaderData,
  k as ServerDataFunctionArgs,
  l as MiddlewareNextFunction,
  m as ClientDataFunctionArgs,
  D as DataStrategyResult,
  n as ServerDataFrom,
  N as Normalize,
  o as GetActionData,
...
type MetaMatches<T extends Array<MatchInfo>> = T extends [
  infer F extends MatchInfo,
  ...infer R extends Array<MatchInfo>,
]
...
type IsServerFirstRoute<T extends RouteInfo, RSCEnabled extends boolean> = RSCEnabled extends true
  ? T["module"] extends {
...
type Matches<T extends Array<MatchInfo>> = T extends [
  infer F extends MatchInfo,
  ...infer R extends Array<MatchInfo>,
]
  ? [Match<F>, ...Matches<R>]
