...
function getHydrationData({ state, routes, getRouteInfo, location, basename, isSpaMode }) {
  ...
  if (initialMatches) {
    for (let match of initialMatches) {
      ...
      if (
        _chunkVNR6V74Njs.shouldHydrateRouteLoader.call(
          void 0,
          routeId,
...
function ErrorWrapper({ renderAppShell, title, children }) {
  ...
  return /* @__PURE__ */ _react2.default.createElement(
    ...
    /* @__PURE__ */ _react2.default.createElement(
      "head",
      null,
      /* @__PURE__ */ _react2.default.createElement("meta", { charSet: "utf-8" }),
      /* @__PURE__ */ _react2.default.createElement("meta", {
        name: "viewport",
        content: "width=device-width,initial-scale=1,viewport-fit=cover",
      }),
      /* @__PURE__ */ _react2.default.createElement("title", null, title)
    ),
    /* @__PURE__ */ _react2.default.createElement(
      "body",
      null,
...
function RSCDefaultRootErrorBoundaryImpl({ error, renderAppShell }) {
  console.error(error);
  let heyDeveloper = /* @__PURE__ */ _react2.default.createElement("script", {
