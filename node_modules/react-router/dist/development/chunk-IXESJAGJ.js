...
try {
  if (isBrowser) {
    window.__reactRouterVersion = "7.9.5"; // @ts-expect-error
  }
} catch (e) {}
function createBrowserRouter(routes, opts) {
  return _chunkVNR6V74Njs.createRouter
    .call(void 0, {
      ...
      history: _chunkVNR6V74Njs.createBrowserHistory.call(void 0, {
        window: _optionalChain([opts, "optionalAccess", (_5) => _5.window]),
      }),
      hydrationData:
        _optionalChain([opts, "optionalAccess", (_6) => _6.hydrationData]) || parseHydrationData(),
      routes,
      ...
      unstable_instrumentations: _optionalChain([
        opts,
        "optionalAccess",
        (_10) => _10.unstable_instrumentations,
      ]),
    })
    .initialize();
}
function createHashRouter(routes, opts) {
  return _chunkVNR6V74Njs.createRouter
    .call(void 0, {
      ...
      history: _chunkVNR6V74Njs.createHashHistory.call(void 0, {
        window: _optionalChain([opts, "optionalAccess", (_14) => _14.window]),
      }),
      hydrationData:
        _optionalChain([opts, "optionalAccess", (_15) => _15.hydrationData]) ||
        parseHydrationData(),
      routes,
      mapRouteProperties: _chunkVNR6V74Njs.mapRouteProperties,
      hydrationRouteProperties: _chunkVNR6V74Njs.hydrationRouteProperties,
      ...
      unstable_instrumentations: _optionalChain([
        opts,
        "optionalAccess",
        (_19) => _19.unstable_instrumentations,
      ]),
    })
    .initialize();
}
...
function BrowserRouter({ basename, children, window: window2 }) {
  ...
  if (historyRef.current == null) {
    historyRef.current = _chunkVNR6V74Njs.createBrowserHistory.call(void 0, {
      window: window2,
      v5Compat: true,
    });
  }
  ...
  return /* @__PURE__ */ React.createElement(_chunkVNR6V74Njs.Router, {
    basename,
    children,
...
function HashRouter({ basename, children, window: window2 }) {
  let historyRef = React.useRef();
  if (historyRef.current == null) {
    historyRef.current = _chunkVNR6V74Njs.createHashHistory.call(void 0, {
      window: window2,
      v5Compat: true,
    });
  }
...
var Link = React.forwardRef(function LinkWithRef(
  {
    onClick,
    discover = "render",
    prefetch = "none",
  ...
  return shouldPrefetch && !isAbsolute
    ? /* @__PURE__ */ React.createElement(
        ...
        null,
        link,
        /* @__PURE__ */ React.createElement(_chunkVNR6V74Njs.PrefetchPageLinks, { page: href })
      )
    : link;
});
Link.displayName = "Link";
var NavLink = React.forwardRef(function NavLinkWithRef(
  {
  ...
  if (nextLocationPathname && basename) {
    nextLocationPathname =
      _chunkVNR6V74Njs.stripBasename.call(void 0, nextLocationPathname, basename) ||
      nextLocationPathname;
  }
    ...
    (event) => {
      if (shouldProcessLinkClick(event, target)) {
        ...
        let replace =
          replaceProp !== void 0
            ? replaceProp
            : _chunkVNR6V74Njs.createPath.call(void 0, location) ===
              _chunkVNR6V74Njs.createPath.call(void 0, path);
        navigate(to, {
          replace,
          state,
          preventScrollReset,
...
function useFormAction(action, { relative } = {}) {
  ...
  let path = {
    ..._chunkVNR6V74Njs.useResolvedPath.call(void 0, action ? action : ".", { relative }),
  };
  let location = _chunkVNR6V74Njs.useLocation.call(void 0);
  if (action == null) {
  ...
  if (basename !== "/") {
    path.pathname =
      path.pathname === "/"
        ? basename
        : _chunkVNR6V74Njs.joinPaths.call(void 0, [basename, path.pathname]);
  }
...
function useFetcher({ key } = {}) {
  ...
  let routeId = _optionalChain([
    ...
    (_23) => _23.matches,
    "access",
    (_24) => _24[route.matches.length - 1],
    "optionalAccess",
    (_25) => _25.route,
    "access",
    (_26) => _26.id,
      ...
      key = getKey(
        {
          ...location,
          pathname:
            _chunkVNR6V74Njs.stripBasename.call(void 0, location.pathname, basename) ||
            location.pathname,
        },
        matches
      );
  ...
  if (typeof document !== "undefined") {
    ...
    React.useLayoutEffect(() => {
      let disableScrollRestoration = _optionalChain([
        router,
        "optionalAccess",
        (_27) => _27.enableScrollRestoration,
        "call",
        (_28) =>
          _28(
            ...
            getKey
              ? (location2, matches2) =>
                  getScrollRestorationKey(location2, matches2, basename, getKey)
              : void 0
          ),
      ]);
...
function useViewTransitionState(to, { relative } = {}) {
  ...
  let { basename } = useDataRouterContext("useViewTransitionState" /* useViewTransitionState */);
  let path = _chunkVNR6V74Njs.useResolvedPath.call(void 0, to, { relative });
  if (!vtContext.isTransitioning) {
    return false;
  }
  let currentPath =
    _chunkVNR6V74Njs.stripBasename.call(void 0, vtContext.currentLocation.pathname, basename) ||
    vtContext.currentLocation.pathname;
  let nextPath =
    _chunkVNR6V74Njs.stripBasename.call(void 0, vtContext.nextLocation.pathname, basename) ||
    vtContext.nextLocation.pathname;
  return (
    _chunkVNR6V74Njs.matchPath.call(void 0, path.pathname, nextPath) != null ||
    _chunkVNR6V74Njs.matchPath.call(void 0, path.pathname, currentPath) != null
  );
}
...
function StaticRouter({ basename, children, location: locationProp = "/" }) {
  ...
  return /* @__PURE__ */ React2.createElement(_chunkVNR6V74Njs.Router, {
    basename,
    children,
    location,
...
function StaticRouterProvider({ context, router, hydrate = true, nonce }) {
  ...
  return /* @__PURE__ */ React2.createElement(
    ...
    /* @__PURE__ */ React2.createElement(
      _chunkVNR6V74Njs.DataRouterContext.Provider,
      { value: dataRouterContext },
      /* @__PURE__ */ React2.createElement(
        _chunkVNR6V74Njs.DataRouterStateContext.Provider,
        { value: state },
        /* @__PURE__ */ React2.createElement(
          _chunkVNR6V74Njs.FetchersContext.Provider,
          { value: fetchersContext },
          /* @__PURE__ */ React2.createElement(
            _chunkVNR6V74Njs.ViewTransitionContext.Provider,
            ...
            /* @__PURE__ */ React2.createElement(
              ...
              /* @__PURE__ */ React2.createElement(DataRoutes, {
