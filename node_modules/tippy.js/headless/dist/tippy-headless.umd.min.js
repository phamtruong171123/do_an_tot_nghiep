!(function (e, t) {
  ...
  function A() {
    ...
    (e - x < 20 &&
      ((T.isTouch = !1), document.removeEventListener('mousemove', A)),
      (x = e));
  }
  function D() {
  ...
  function B(o, s) {
        ...
        setProps: function (e) {
          ...
          ((z.props = n),
            ...
            t.interactiveDebounce !== n.interactiveDebounce &&
              (ce(), (X = a(we, n.interactiveDebounce))));
          ...
          ((A = function () {
            ...
            (function () {
              var e,
                ...
                r = te();
              e =
                (z.props.interactive && t === n) || 'parent' === t
                  ? r.parentNode
                  : i(t, [r]);
    ...
    return (
      ...
      W.addEventListener('mouseleave', function () {
        z.props.interactive &&
          ...
          ne().addEventListener('mousemove', X);
      }),
      z
    );
    function Q() {
      ...
      !K &&
        ...
        u(z.props.triggerTarget || o).forEach(function (e) {
          z.props.interactive
            ? e.setAttribute(
                'aria-expanded',
                z.state.isVisible && e === te() ? 'true' : 'false',
              )
            : e.removeAttribute('aria-expanded');
        });
    }
    ...
    function he() {
      ...
      (Z() &&
        ...
        ((e = z.props.trigger), e.split(/\s+/).filter(Boolean)).forEach(
          function (e) {
            if ('manual' !== e)
              switch ((ge(e, ye), e)) {
                case 'mouseenter':
    ...
    function Ee(e) {
      Te(e) ||
        (z.props.trigger.indexOf('click') >= 0 && N) ||
        (z.props.interactive ? z.hideWithInteractivity(e) : Le(e));
    }
    function Oe(e) {
    ...
    function xe() {
      ...
      var t = z.props,
        ...
        u = ee() ? V(W).arrow : null,
        c = a
          ? {getBoundingClientRect: a, contextElement: a.contextElement || te()}
          : o,
        p = [
      ...
      (ee() && u && p.push({name: 'arrow', options: {element: u, padding: 3}}),
        ...
        (z.popperInstance = e.createPopper(
          c,
          W,
    ...
    function Le(e) {
      if (
        (z.clearDelayTimeouts(), ae('onUntrigger', [z, e]), z.state.isVisible)
      ) {
        if (
          !(
            z.props.trigger.indexOf('mouseenter') >= 0 &&
  ...
  function N(e, n) {
    ...
    (document.addEventListener('touchstart', C, t),
    ...
    fn: function (e) {
      ...
      return {
        ...
        onTrigger: function (e, t) {
          (m(t) && (F = {clientX: t.clientX, clientY: t.clientY}),
            (o = 'focus' === t.type));
        },
        onHidden: function () {
          ...
          if (t) {
            ...
            if (
              ...
              !(
                ...
                ('touchstart' !== e.type && r.indexOf(H[e.type]) < 0)
              )
            ) {
              var s = N(t, f);
              s && (o = o.concat(s));
